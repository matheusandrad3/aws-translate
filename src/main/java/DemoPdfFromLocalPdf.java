...
public class DemoPdfFromLocalPdf {
    ...
    public String run(String documentName, String outputDocumentName, String sourceLanguage, String destinationLanguage, boolean retainFormatting) throws IOException {
